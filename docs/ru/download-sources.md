...
Опции загрузки от `Wkeynhk`, в названии которых есть `Pioneer` или `Canek77`, также будет поставляться с кряком, который активирует многопользовательский режим, аналогичный `Online-Fix`, или от `Online-Fix`, соответственно.
